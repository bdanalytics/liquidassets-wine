...
model_id <- "csm.AGST"; indep_vars_vctr <- c(NULL
   ,"AGST" #"<feat1>"
#    ,"<feat1>*<feat2>"
#    ,"<feat1>:<feat2>"
                                           )
model_id <- "csm.AGST.HarvestRain"; indep_vars_vctr <- c(NULL
   ,"AGST","HarvestRain" #"<feat1>"
#    ,"<feat1>*<feat2>"
#    ,"<feat1>:<feat2>"
                                           )
model_id <- "csm.HarvestRain.WinterRain"; indep_vars_vctr <- c(NULL
   ,"HarvestRain","WinterRain" #"<feat1>"
#    ,"<feat1>*<feat2>"
#    ,"<feat1>:<feat2>"
                                           )
for (method in c("lm")) {
