# Wine: LiquidAssets: Price regression:: Wine2
bdanalytics  
...
Data: 
Source: 
    Training:   https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/wine.csv  
    New:        https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/wine_test.csv  
Time period: 
...
glb_trnng_url <- "https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/wine.csv"
glb_newdt_url <- "https://courses.edx.org/asset-v1:MITx+15.071x_2a+2T2015+type@asset+block/wine_test.csv"
glb_out_pfx <- "Wine2_"
...
![](LiquidAssets_Wine2_files/figure-html/set_global_options-1.png) 
...
```
##          label step_major step_minor   bgn   end elapsed
## 1  import.data          1          0 9.296 9.634   0.338
## 2 inspect.data          2          0 9.635    NA      NA
```
...
![](LiquidAssets_Wine2_files/figure-html/inspect.data-1.png) 
...
![](LiquidAssets_Wine2_files/figure-html/inspect.data-2.png) 

```
## [1] "feat: AGST"
```

![](LiquidAssets_Wine2_files/figure-html/inspect.data-3.png) 

```
## [1] "feat: HarvestRain"
```

![](LiquidAssets_Wine2_files/figure-html/inspect.data-4.png) 

```
## [1] "feat: Age"
```

![](LiquidAssets_Wine2_files/figure-html/inspect.data-5.png) 

```
## [1] "feat: FrancePop"
```

![](LiquidAssets_Wine2_files/figure-html/inspect.data-6.png) 

```
## [1] "feat: .rnorm"
```

![](LiquidAssets_Wine2_files/figure-html/inspect.data-7.png) 
...
```
##          label step_major step_minor    bgn    end elapsed
## 2 inspect.data          2          0  9.635 12.848   3.213
## 3   scrub.data          2          1 12.849     NA      NA
```
...
```
##            label step_major step_minor    bgn    end elapsed
## 3     scrub.data          2          1 12.849 13.784   0.935
## 4 transform.data          2          2 13.784     NA      NA
```
...
```
##                 label step_major step_minor    bgn    end elapsed
## 4      transform.data          2          2 13.784 13.819   0.035
## 5 manage.missing.data          2          3 13.819     NA      NA
```
...
```
##                 label step_major step_minor    bgn   end elapsed
## 5 manage.missing.data          2          3 13.819 13.88   0.061
## 6    extract.features          3          0 13.881    NA      NA
```
...
```
##                  label step_major step_minor    bgn end elapsed
## 1 extract.features_bgn          1          0 13.886  NA      NA
```
...
## 1                extract.features_bgn          1          0 13.886 13.894
## 2 extract.features_factorize.str.vars          2          0 13.894     NA
##   elapsed
## 1   0.008
## 2      NA
```
...
```
##                                 label step_major step_minor    bgn   end
## 2 extract.features_factorize.str.vars          2          0 13.894 13.91
## 3                extract.features_end          3          0 13.910    NA
##   elapsed
## 2   0.016
## 3      NA
```
...
```
##                                 label step_major step_minor    bgn    end
## 2 extract.features_factorize.str.vars          2          0 13.894 13.910
## 1                extract.features_bgn          1          0 13.886 13.894
##   elapsed duration
## 2   0.016    0.016
## 1   0.008    0.008
## [1] "Total Elapsed Time: 13.91 secs"
```

![](LiquidAssets_Wine2_files/figure-html/extract.features-1.png) 
...
![](LiquidAssets_Wine2_files/figure-html/extract.features-2.png) 
...
```
##              label step_major step_minor    bgn    end elapsed
## 6 extract.features          3          0 13.881 14.953   1.072
## 7     cluster.data          4          0 14.954     NA      NA
```
...
```
##             label step_major step_minor    bgn    end elapsed
## 7    cluster.data          4          0 14.954 15.213   0.259
## 8 select.features          5          0 15.213     NA      NA
```
...
## AGST               AGST  0.65956286               0 0.65956286
## HarvestRain HarvestRain -0.56332190               0 0.56332190
## FrancePop     FrancePop -0.46686164               0 0.46686164
## Year               Year -0.44776786               1 0.44776786
## Age                 Age  0.44776786               0 0.44776786
## WinterRain   WinterRain  0.13665055               0 0.13665055
## .rnorm           .rnorm  0.07292805               0 0.07292805
```
...
## glb_trnobs_df, : Identified Age as highly correlated with FrancePop
```

```
##            id       cor.y exclude.as.feat  cor.y.abs cor.high.X freqRatio
## 3        AGST  0.65956286               0 0.65956286       <NA>         1
## 2         Age  0.44776786               0 0.44776786  FrancePop         1
## 6  WinterRain  0.13665055               0 0.13665055       <NA>         2
## 1      .rnorm  0.07292805               0 0.07292805       <NA>         1
## 7        Year -0.44776786               1 0.44776786       <NA>         1
## 4   FrancePop -0.46686164               0 0.46686164       <NA>         1
## 5 HarvestRain -0.56332190               0 0.56332190       <NA>         2
##   percentUnique zeroVar   nzv myNearZV is.cor.y.abs.low
## 3            92   FALSE FALSE    FALSE            FALSE
## 2           100   FALSE FALSE    FALSE            FALSE
## 6            96   FALSE FALSE    FALSE            FALSE
## 1           100   FALSE FALSE    FALSE            FALSE
## 7           100   FALSE FALSE    FALSE            FALSE
## 4           100   FALSE FALSE    FALSE            FALSE
## 5            96   FALSE FALSE    FALSE            FALSE
```
...
```
## Warning in loop_apply(n, do.ply): NAs produced
```
...
![](LiquidAssets_Wine2_files/figure-html/select.features-1.png) 
...
```
##                     label step_major step_minor    bgn    end elapsed
## 8         select.features          5          0 15.213 15.767   0.554
## 9 partition.data.training          6          0 15.768     NA      NA
```
...
```
##          id      cor.y exclude.as.feat cor.y.abs cor.high.X freqRatio
## 7      Year -0.4477679            TRUE 0.4477679       <NA>         1
...
```
##                      label step_major step_minor    bgn    end elapsed
## 9  partition.data.training          6          0 15.768 16.061   0.294
## 10              fit.models          7          0 16.062     NA      NA
```
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_0-1.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-2.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-3.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-4.png) 
...
## -0.8903 -0.5501  0.1015  0.5275  1.4077 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  7.08116    0.13834  51.185   <2e-16 ***
## .rnorm       0.04385    0.12505   0.351    0.729    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.6626 on 23 degrees of freedom
## Multiple R-squared:  0.005319,	Adjusted R-squared:  -0.03793 
## F-statistic: 0.123 on 1 and 23 DF,  p-value: 0.729
## 
## [1] "    calling mypredict_mdl for fit:"
## [1] "    calling mypredict_mdl for OOB:"
##   model_id model_method  feats max.nTuningRuns min.elapsedtime.everything
## 1   MFO.lm           lm .rnorm               0                      0.434
##   min.elapsedtime.final max.R.sq.fit min.RMSE.fit max.R.sq.OOB
## 1                 0.003  0.005318501    0.6355046   0.03093636
##   min.RMSE.OOB max.Adj.R.sq.fit
## 1    0.4040443      -0.03792852
```
...
```
## Fitting cp = 0.431 on full training set
```
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_0-5.png) 
...
## 1 0.4309405      0         1
## 
## Node number 1: 25 observations
##   mean=7.067224, MSE=0.4060255 
## 
## n= 25 
## 
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_0-6.png) 
...
## 
##          CP nsplit rel error
## 1 0.4309405      0 1.0000000
## 2 0.0000000      1 0.5690595
## 
## Variable importance
##        AGST HarvestRain 
##          92           8 
## 
## Node number 1: 25 observations,    complexity param=0.4309405
##   mean=7.067224, MSE=0.4060255 
##   left son=2 (14 obs) right son=3 (11 obs)
##   Primary splits:
##       AGST        < 16.60835 to the left,  improve=0.4309405, (0 missing)
##       HarvestRain < 103      to the right, improve=0.2180438, (0 missing)
##   Surrogate splits:
##       HarvestRain < 142.5    to the right, agree=0.6, adj=0.091, (0 split)
## 
## Node number 2: 14 observations
##   mean=6.696443, MSE=0.2199036 
## 
## Node number 3: 11 observations
##   mean=7.539127, MSE=0.2452423 
## 
## n= 25 
## 
## node), split, n, deviance, yval
##       * denotes terminal node
## 
## 1) root 25 10.150640 7.067224  
##   2) AGST< 16.60835 14  3.078651 6.696443 *
##   3) AGST>=16.60835 11  2.697666 7.539127 *
## [1] "    calling mypredict_mdl for fit:"
## [1] "    calling mypredict_mdl for OOB:"
##                    model_id model_method             feats max.nTuningRuns
## 1 Max.cor.Y.cv.0.cp.0.rpart        rpart AGST, HarvestRain               0
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.434                 0.007    0.4309405
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB
## 1    0.4806794    0.6859661     0.230007
```
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_0-7.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-8.png) 
...
## [1] "    calling mypredict_mdl for OOB:"
##          model_id model_method             feats max.nTuningRuns
## 1 Max.cor.Y.rpart        rpart AGST, HarvestRain               3
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.913                 0.007            0
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Rsquared.fit min.RMSESD.fit
## 1     0.635538            0     0.410443              NaN       0.112817
##   max.RsquaredSD.fit
## 1                 NA
```
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_0-9.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-10.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-11.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-12.png) 
...
## [1] "    calling mypredict_mdl for OOB:"
##       model_id model_method             feats max.nTuningRuns
## 1 Max.cor.Y.lm           lm AGST, HarvestRain               1
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.812                 0.003    0.7073708
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.fit max.Rsquared.fit
## 1    0.3556647  -0.08199948    0.4269395        0.6807681        0.7153633
##   min.RMSESD.fit max.RsquaredSD.fit
## 1     0.07634126          0.1186477
```
...
## [1] "    indep_vars: AGST, HarvestRain, AGST:FrancePop"
## Aggregating results
## Fitting final model on full training set
```

![](LiquidAssets_Wine2_files/figure-html/fit.models_0-13.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-14.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-15.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-16.png) 
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -0.63725 -0.21826 -0.02309  0.29330  0.46283 
## 
## Coefficients:
##                    Estimate Std. Error t value Pr(>|t|)    
## (Intercept)      -1.037e+00  1.637e+00  -0.633  0.53329    
## AGST              6.925e-01  1.001e-01   6.921 7.74e-07 ***
## HarvestRain      -4.476e-03  8.666e-04  -5.165 4.06e-05 ***
## `AGST:FrancePop` -3.248e-06  1.087e-06  -2.987  0.00703 ** 
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.3151 on 21 degrees of freedom
## Multiple R-squared:  0.7946,	Adjusted R-squared:  0.7653 
## F-statistic: 27.08 on 3 and 21 DF,  p-value: 2.066e-07
## 
## [1] "    calling mypredict_mdl for fit:"
## [1] "    calling mypredict_mdl for OOB:"
##                 model_id model_method                             feats
## 1 Interact.High.cor.Y.lm           lm AGST, HarvestRain, AGST:FrancePop
##   max.nTuningRuns min.elapsedtime.everything min.elapsedtime.final
## 1               1                      0.808                 0.003
##   max.R.sq.fit min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.fit
## 1    0.7946092    0.2995031    0.4920449    0.2925267        0.7652676
##   max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1        0.8010596     0.05596954         0.07281461
```
...
## [1] "    indep_vars: AGST, WinterRain, .rnorm, FrancePop, HarvestRain"
## Aggregating results
## Fitting final model on full training set
```

![](LiquidAssets_Wine2_files/figure-html/fit.models_0-17.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-18.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-19.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_0-20.png) 
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -0.4759 -0.2362 -0.0083  0.2044  0.4996 
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -4.302e-01  2.231e+00  -0.193 0.849167    
## AGST         6.029e-01  1.012e-01   5.957 9.83e-06 ***
## WinterRain   1.078e-03  5.255e-04   2.052 0.054259 .  
## .rnorm       2.363e-02  5.792e-02   0.408 0.687900    
## FrancePop   -5.074e-05  1.741e-05  -2.914 0.008893 ** 
## HarvestRain -3.902e-03  8.808e-04  -4.430 0.000287 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.3006 on 19 degrees of freedom
## Multiple R-squared:  0.8308,	Adjusted R-squared:  0.7863 
## F-statistic: 18.66 on 5 and 19 DF,  p-value: 9.635e-07
## 
## [1] "    calling mypredict_mdl for fit:"
## [1] "    calling mypredict_mdl for OOB:"
...
## 1 AGST, WinterRain, .rnorm, FrancePop, HarvestRain               1
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.829                 0.003    0.8308401
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.fit max.Rsquared.fit
## 1    0.2912797    0.7981196    0.1844166        0.7863244        0.8097281
##   min.RMSESD.fit max.RsquaredSD.fit
## 1     0.02813009         0.04984159
```
...
```
##         label step_major step_minor    bgn    end elapsed
## 10 fit.models          7          0 16.062 29.214  13.152
## 11 fit.models          7          1 29.214     NA      NA
```
...
```
##              label step_major step_minor    bgn end elapsed
## 1 fit.models_1_bgn          1          0 30.664  NA      NA
```
...
```
##              label step_major step_minor    bgn    end elapsed
## 1 fit.models_1_bgn          1          0 30.664 30.676   0.013
## 2  fit.models_1_lm          2          0 30.677     NA      NA
## [1] "fitting model: All.X.lm"
## [1] "    indep_vars: AGST, Age, WinterRain, .rnorm, FrancePop, HarvestRain"
## Aggregating results
## Fitting final model on full training set
```

![](LiquidAssets_Wine2_files/figure-html/fit.models_1-1.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_1-2.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_1-3.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_1-4.png) 
...
## Residuals:
##      Min       1Q   Median       3Q      Max 
## -0.47395 -0.23778 -0.00723  0.20581  0.50061 
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -6.273e-01  1.043e+01  -0.060 0.952714    
## AGST         6.032e-01  1.055e-01   5.718 2.02e-05 ***
## Age          1.566e-03  8.085e-02   0.019 0.984759    
## WinterRain   1.080e-03  5.514e-04   1.959 0.065777 .  
## .rnorm       2.366e-02  5.954e-02   0.397 0.695716    
## FrancePop   -4.745e-05  1.706e-04  -0.278 0.784039    
## HarvestRain -3.903e-03  9.059e-04  -4.309 0.000423 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 0.3089 on 18 degrees of freedom
## Multiple R-squared:  0.8308,	Adjusted R-squared:  0.7745 
## F-statistic: 14.74 on 6 and 18 DF,  p-value: 4.484e-06
## 
## [1] "    calling mypredict_mdl for fit:"
## [1] "    calling mypredict_mdl for OOB:"
##   model_id model_method
## 1 All.X.lm           lm
##                                                   feats max.nTuningRuns
## 1 AGST, Age, WinterRain, .rnorm, FrancePop, HarvestRain               1
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.798                 0.003    0.8308437
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.fit max.Rsquared.fit
## 1    0.3235517    0.8022993    0.1824975        0.7744582        0.7670909
##   min.RMSESD.fit max.RsquaredSD.fit
## 1     0.04699995         0.02454145
##              label step_major step_minor    bgn    end elapsed
## 2  fit.models_1_lm          2          0 30.677 33.042   2.365
## 3 fit.models_1_glm          3          0 33.042     NA      NA
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_1-5.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_1-6.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_1-7.png) 
...
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for gaussian family taken to be 0.09539138)
## 
##     Null deviance: 10.151  on 24  degrees of freedom
## Residual deviance:  1.717  on 18  degrees of freedom
## AIC: 19.99
## 
...
## 1 AGST, Age, WinterRain, .rnorm, FrancePop, HarvestRain               1
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.846                 0.007    0.8308437
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB min.aic.fit max.Rsquared.fit
## 1    0.3235517    0.8022993    0.1824975    19.99015        0.7670909
##   min.RMSESD.fit max.RsquaredSD.fit
## 1     0.04699995         0.02454145
##                   label step_major step_minor    bgn    end elapsed
## 3      fit.models_1_glm          3          0 33.042 36.378   3.336
## 4 fit.models_1_bayesglm          4          0 36.378     NA      NA
...
## 
## Working directory is /Users/bbalaji-2012/Documents/Work/Courses/MIT/Analytics_Edge_15_071x/Lectures/LCTR2_LiquidAssets_Wine
```
...
## Deviance Residuals: 
##      Min        1Q    Median        3Q       Max  
## -0.47444  -0.23706  -0.00695   0.20716   0.50150  
## 
## Coefficients:
##               Estimate Std. Error t value Pr(>|t|)    
## (Intercept) -5.831e-01  1.042e+01  -0.056 0.956007    
## AGST         6.020e-01  1.054e-01   5.712 2.04e-05 ***
## Age          1.405e-03  8.080e-02   0.017 0.986322    
## WinterRain   1.078e-03  5.513e-04   1.955 0.066303 .  
## .rnorm       2.361e-02  5.952e-02   0.397 0.696218    
## FrancePop   -4.785e-05  1.705e-04  -0.281 0.782157    
## HarvestRain -3.905e-03  9.058e-04  -4.311 0.000421 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for gaussian family taken to be 0.09539215)
## 
##     Null deviance: 10.1506  on 24  degrees of freedom
## Residual deviance:  1.7171  on 18  degrees of freedom
## AIC: 19.99
## 
...
## 1 AGST, Age, WinterRain, .rnorm, FrancePop, HarvestRain               1
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      1.367                 0.017    0.8308423
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB min.aic.fit max.Rsquared.fit
## 1    0.3238942    0.8010561    0.1829985    19.99035        0.7668579
##   min.RMSESD.fit max.RsquaredSD.fit
## 1     0.04679248         0.02434823
##                   label step_major step_minor    bgn    end elapsed
## 4 fit.models_1_bayesglm          4          0 36.378 38.593   2.215
## 5    fit.models_1_rpart          5          0 38.594     NA      NA
## [1] "fitting model: All.X.no.rnorm.rpart"
## [1] "    indep_vars: AGST, Age, WinterRain, FrancePop, HarvestRain"
```
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_1-8.png) 
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_1-9.png) 
...
##                                           feats max.nTuningRuns
## 1 AGST, Age, WinterRain, FrancePop, HarvestRain               3
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.833                 0.007            0
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Rsquared.fit min.RMSESD.fit
## 1     0.635538            0     0.410443              NaN       0.112817
...
## 1                 NA
##                label step_major step_minor    bgn    end elapsed
## 5 fit.models_1_rpart          5          0 38.594 40.731   2.137
## 6    fit.models_1_rf          6          0 40.731     NA      NA
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_1-10.png) 
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_1-11.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_1-12.png) 

```
##                 Length Class      Mode     
## call              4    -none-     call     
## type              1    -none-     character
## predicted        25    -none-     numeric  
## mse             500    -none-     numeric  
## rsq             500    -none-     numeric  
## oob.times        25    -none-     numeric  
...
## 1 AGST, Age, WinterRain, FrancePop, HarvestRain               3
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      1.099                 0.024    0.8998729
##   min.RMSE.fit max.R.sq.OOB min.RMSE.OOB max.Rsquared.fit min.RMSESD.fit
## 1    0.4285571   0.06103049    0.4009895        0.6783551      0.1227792
##   max.RsquaredSD.fit
## 1          0.1114512
```
...
##                                                                           feats
## MFO.lm                                                                   .rnorm
## Max.cor.Y.cv.0.rpart                                          AGST, HarvestRain
## Max.cor.Y.cv.0.cp.0.rpart                                     AGST, HarvestRain
## Max.cor.Y.rpart                                               AGST, HarvestRain
## Max.cor.Y.lm                                                  AGST, HarvestRain
## Interact.High.cor.Y.lm                        AGST, HarvestRain, AGST:FrancePop
## Low.cor.X.lm                   AGST, WinterRain, .rnorm, FrancePop, HarvestRain
## All.X.lm                  AGST, Age, WinterRain, .rnorm, FrancePop, HarvestRain
## All.X.glm                 AGST, Age, WinterRain, .rnorm, FrancePop, HarvestRain
## All.X.bayesglm            AGST, Age, WinterRain, .rnorm, FrancePop, HarvestRain
## All.X.no.rnorm.rpart              AGST, Age, WinterRain, FrancePop, HarvestRain
## All.X.no.rnorm.rf                 AGST, Age, WinterRain, FrancePop, HarvestRain
##                           max.nTuningRuns min.elapsedtime.everything
## MFO.lm                                  0                      0.434
## Max.cor.Y.cv.0.rpart                    0                      0.532
## Max.cor.Y.cv.0.cp.0.rpart               0                      0.434
## Max.cor.Y.rpart                         3                      0.913
## Max.cor.Y.lm                            1                      0.812
## Interact.High.cor.Y.lm                  1                      0.808
## Low.cor.X.lm                            1                      0.829
## All.X.lm                                1                      0.798
## All.X.glm                               1                      0.846
## All.X.bayesglm                          1                      1.367
## All.X.no.rnorm.rpart                    3                      0.833
## All.X.no.rnorm.rf                       3                      1.099
##                           min.elapsedtime.final max.R.sq.fit min.RMSE.fit
## MFO.lm                                    0.003  0.005318501    0.6355046
## Max.cor.Y.cv.0.rpart                      0.007  0.000000000    0.6372013
## Max.cor.Y.cv.0.cp.0.rpart                 0.007  0.430940497    0.4806794
## Max.cor.Y.rpart                           0.007  0.000000000    0.6355380
## Max.cor.Y.lm                              0.003  0.707370766    0.3556647
## Interact.High.cor.Y.lm                    0.003  0.794609155    0.2995031
## Low.cor.X.lm                              0.003  0.830840125    0.2912797
## All.X.lm                                  0.003  0.830843651    0.3235517
## All.X.glm                                 0.007  0.830843651    0.3235517
## All.X.bayesglm                            0.017  0.830842305    0.3238942
## All.X.no.rnorm.rpart                      0.007  0.000000000    0.6355380
## All.X.no.rnorm.rf                         0.024  0.899872888    0.4285571
##                           max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.fit
## MFO.lm                      0.03093636    0.4040443      -0.03792852
## Max.cor.Y.cv.0.rpart        0.00000000    0.4104430               NA
## Max.cor.Y.cv.0.cp.0.rpart   0.68596606    0.2300070               NA
## Max.cor.Y.rpart             0.00000000    0.4104430               NA
## Max.cor.Y.lm               -0.08199948    0.4269395       0.68076811
## Interact.High.cor.Y.lm      0.49204495    0.2925267       0.76526761
## Low.cor.X.lm                0.79811956    0.1844166       0.78632437
## All.X.lm                    0.80229929    0.1824975       0.77445820
## All.X.glm                   0.80229929    0.1824975               NA
## All.X.bayesglm              0.80105609    0.1829985               NA
## All.X.no.rnorm.rpart        0.00000000    0.4104430               NA
## All.X.no.rnorm.rf           0.06103049    0.4009895               NA
##                           max.Rsquared.fit min.RMSESD.fit
## MFO.lm                                  NA             NA
## Max.cor.Y.cv.0.rpart                    NA             NA
## Max.cor.Y.cv.0.cp.0.rpart               NA             NA
## Max.cor.Y.rpart                        NaN     0.11281698
## Max.cor.Y.lm                     0.7153633     0.07634126
## Interact.High.cor.Y.lm           0.8010596     0.05596954
## Low.cor.X.lm                     0.8097281     0.02813009
## All.X.lm                         0.7670909     0.04699995
## All.X.glm                        0.7670909     0.04699995
## All.X.bayesglm                   0.7668579     0.04679248
## All.X.no.rnorm.rpart                   NaN     0.11281698
## All.X.no.rnorm.rf                0.6783551     0.12277920
##                           max.RsquaredSD.fit min.aic.fit
## MFO.lm                                    NA          NA
## Max.cor.Y.cv.0.rpart                      NA          NA
## Max.cor.Y.cv.0.cp.0.rpart                 NA          NA
## Max.cor.Y.rpart                           NA          NA
## Max.cor.Y.lm                      0.11864775          NA
## Interact.High.cor.Y.lm            0.07281461          NA
## Low.cor.X.lm                      0.04984159          NA
## All.X.lm                          0.02454145          NA
## All.X.glm                         0.02454145    19.99015
## All.X.bayesglm                    0.02434823    19.99035
## All.X.no.rnorm.rpart                      NA          NA
## All.X.no.rnorm.rf                 0.11145122          NA
```
...
```
##              label step_major step_minor    bgn   end elapsed
## 6  fit.models_1_rf          6          0 40.731 43.17   2.439
## 7 fit.models_1_end          7          0 43.170    NA      NA
```
...
```
##         label step_major step_minor    bgn    end elapsed
## 11 fit.models          7          1 29.214 43.176  13.963
## 12 fit.models          7          2 43.177     NA      NA
```
...
## MFO.lm                                  0  0.005318501   0.03093636
## Max.cor.Y.cv.0.rpart                    0  0.000000000   0.00000000
## Max.cor.Y.cv.0.cp.0.rpart               0  0.430940497   0.68596606
## Max.cor.Y.rpart                         3  0.000000000   0.00000000
## Max.cor.Y.lm                            1  0.707370766  -0.08199948
## Interact.High.cor.Y.lm                  1  0.794609155   0.49204495
## Low.cor.X.lm                            1  0.830840125   0.79811956
## All.X.lm                                1  0.830843651   0.80229929
## All.X.glm                               1  0.830843651   0.80229929
## All.X.bayesglm                          1  0.830842305   0.80105609
## All.X.no.rnorm.rpart                    3  0.000000000   0.00000000
## All.X.no.rnorm.rf                       3  0.899872888   0.06103049
##                           max.Adj.R.sq.fit max.Rsquared.fit
## MFO.lm                         -0.03792852               NA
## Max.cor.Y.cv.0.rpart                    NA               NA
## Max.cor.Y.cv.0.cp.0.rpart               NA               NA
## Max.cor.Y.rpart                         NA              NaN
## Max.cor.Y.lm                    0.68076811        0.7153633
## Interact.High.cor.Y.lm          0.76526761        0.8010596
## Low.cor.X.lm                    0.78632437        0.8097281
## All.X.lm                        0.77445820        0.7670909
## All.X.glm                               NA        0.7670909
## All.X.bayesglm                          NA        0.7668579
## All.X.no.rnorm.rpart                    NA              NaN
## All.X.no.rnorm.rf                       NA        0.6783551
##                           inv.elapsedtime.everything inv.elapsedtime.final
## MFO.lm                                     2.3041475             333.33333
## Max.cor.Y.cv.0.rpart                       1.8796992             142.85714
## Max.cor.Y.cv.0.cp.0.rpart                  2.3041475             142.85714
## Max.cor.Y.rpart                            1.0952903             142.85714
## Max.cor.Y.lm                               1.2315271             333.33333
## Interact.High.cor.Y.lm                     1.2376238             333.33333
## Low.cor.X.lm                               1.2062726             333.33333
## All.X.lm                                   1.2531328             333.33333
## All.X.glm                                  1.1820331             142.85714
## All.X.bayesglm                             0.7315289              58.82353
## All.X.no.rnorm.rpart                       1.2004802             142.85714
## All.X.no.rnorm.rf                          0.9099181              41.66667
##                           inv.RMSE.fit inv.RMSE.OOB inv.aic.fit
## MFO.lm                        1.573553     2.474976          NA
## Max.cor.Y.cv.0.rpart          1.569363     2.436392          NA
## Max.cor.Y.cv.0.cp.0.rpart     2.080389     4.347693          NA
## Max.cor.Y.rpart               1.573470     2.436392          NA
## Max.cor.Y.lm                  2.811637     2.342252          NA
## Interact.High.cor.Y.lm        3.338864     3.418492          NA
## Low.cor.X.lm                  3.433126     5.422506          NA
## All.X.lm                      3.090696     5.479527          NA
## All.X.glm                     3.090696     5.479527  0.05002464
## All.X.bayesglm                3.087428     5.464525  0.05002414
## All.X.no.rnorm.rpart          1.573470     2.436392          NA
## All.X.no.rnorm.rf             2.333412     2.493831          NA
```
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_2-1.png) 
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_2-2.png) 
...
## 8                   All.X.lm    0.1824975   0.80229929       0.77445820
## 9                  All.X.glm    0.1824975   0.80229929               NA
## 10            All.X.bayesglm    0.1829985   0.80105609               NA
## 7               Low.cor.X.lm    0.1844166   0.79811956       0.78632437
## 3  Max.cor.Y.cv.0.cp.0.rpart    0.2300070   0.68596606               NA
## 6     Interact.High.cor.Y.lm    0.2925267   0.49204495       0.76526761
## 12         All.X.no.rnorm.rf    0.4009895   0.06103049               NA
## 1                     MFO.lm    0.4040443   0.03093636      -0.03792852
## 2       Max.cor.Y.cv.0.rpart    0.4104430   0.00000000               NA
## 4            Max.cor.Y.rpart    0.4104430   0.00000000               NA
## 11      All.X.no.rnorm.rpart    0.4104430   0.00000000               NA
## 5               Max.cor.Y.lm    0.4269395  -0.08199948       0.68076811
```
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_2-3.png) 
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_2-4.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_2-5.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_2-6.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_2-7.png) 
...
```
## Warning in loop_apply(n, do.ply): at 6.4956
```

```
## Warning in loop_apply(n, do.ply): radius 5.203e-06
```

```
## Warning in loop_apply(n, do.ply): all data on boundary of neighborhood.
## make span bigger
```

```
## Warning in loop_apply(n, do.ply): pseudoinverse used at 6.4956
```

```
## Warning in loop_apply(n, do.ply): neighborhood radius 0.002281
```

```
## Warning in loop_apply(n, do.ply): reciprocal condition number 1
```

```
## Warning in loop_apply(n, do.ply): at 6.9564
```
...
```
## Warning in loop_apply(n, do.ply): zero-width neighborhood. make span bigger
```
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_2-8.png) 

```
##    Year  Price WinterRain    AGST HarvestRain Age FrancePop .src
## 27 1980 6.4979        578 16.0000          74   3  55110.24 Test
## 26 1979 6.9541        717 16.1667         122   4  54835.83 Test
##        .rnorm Price.predict.All.X.lm Price.predict.All.X.lm.err
## 27 -0.7757516               6.731440                  0.2335403
## 26  0.6962816               6.844238                  0.1098618
```
...
## AGST        100.000000          100.000000
## HarvestRain  75.270345           75.270345
## WinterRain   34.040222           34.040222
## .rnorm        6.634743            6.634743
## FrancePop     4.541969            4.541969
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_2-9.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_2-10.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_2-11.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_2-12.png) ![](LiquidAssets_Wine2_files/figure-html/fit.models_2-13.png) 
...
## 27 -0.7757516               6.731440                  0.2335403
## 26  0.6962816               6.844238                  0.1098618
##    Price.predict.All.X.lm.accurate .label
## 27                           FALSE   1980
## 26                           FALSE   1979
```

![](LiquidAssets_Wine2_files/figure-html/fit.models_2-14.png) 
...
```
## [1] Price                           Price.predict.All.X.lm         
## [3] Price.predict.All.X.lm.err      Price.predict.All.X.lm.accurate
## <0 rows> (or 0-length row.names)
```
...
```
## [1] AGST       Age        WinterRain .rnorm     Year      
## <0 rows> (or 0-length row.names)
```
...
```
##         label step_major step_minor    bgn    end elapsed
## 12 fit.models          7          2 43.177 52.448   9.271
## 13 fit.models          7          3 52.449     NA      NA
```
...
```
## [1] "Price.predict.All.X.lm"          "Price.predict.All.X.lm.err"     
## [3] "Price.predict.All.X.lm.accurate"
```
...
![](LiquidAssets_Wine2_files/figure-html/fit.models_3-1.png) 
...
```
##                label step_major step_minor    bgn    end elapsed
## 13        fit.models          7          3 52.449 56.144   3.695
## 14 fit.data.training          8          0 56.144     NA      NA
```
...
![](LiquidAssets_Wine2_files/figure-html/fit.data.training_0-1.png) ![](LiquidAssets_Wine2_files/figure-html/fit.data.training_0-2.png) ![](LiquidAssets_Wine2_files/figure-html/fit.data.training_0-3.png) ![](LiquidAssets_Wine2_files/figure-html/fit.data.training_0-4.png) 
...
## 1 AGST, Age, WinterRain, .rnorm, FrancePop, HarvestRain               1
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.844                 0.005    0.8308437
##   min.RMSE.fit max.Adj.R.sq.fit max.Rsquared.fit min.RMSESD.fit
## 1    0.3235517        0.7744582        0.7670909     0.04699995
##   max.RsquaredSD.fit
## 1         0.02454145
```
...
```
##                label step_major step_minor    bgn    end elapsed
## 14 fit.data.training          8          0 56.144 59.588   3.444
## 15 fit.data.training          8          1 59.588     NA      NA
```
...
![](LiquidAssets_Wine2_files/figure-html/fit.data.training_1-1.png) 

```
##    Year  Price WinterRain    AGST HarvestRain Age FrancePop  .src
## 6  1959 8.0757        485 17.4833         187  24  46128.64 Train
## 24 1977 6.2587        821 15.5833          87   6  54378.36 Train
## 20 1973 6.6367        376 17.0667         123  10  53332.81 Train
## 12 1965 6.2518        602 15.3667         267  18  49801.82 Train
## 19 1972 6.2049        536 14.9833         158  11  52894.18 Train
## 22 1975 7.2920        572 16.9500         171   8  53955.04 Train
##          .rnorm Price.predict.Final.lm Price.predict.Final.lm.err
## 6   0.546043206               7.575087                  0.5006127
## 24 -0.717345556               6.732652                  0.4739520
## 20  0.943560542               7.101442                  0.4647417
## 12 -0.354117074               5.907425                  0.3443753
## 19  0.320071135               5.888516                  0.3163840
## 22 -0.001902476               7.000409                  0.2915909
```
...
## AGST                 100.000000 100.000000          100.000000
## HarvestRain           75.270345  75.270345           75.270345
## WinterRain            34.040222  34.040222           34.040222
## .rnorm                 6.634743   6.634743            6.634743
## FrancePop              4.541969   4.541969            4.541969
...
![](LiquidAssets_Wine2_files/figure-html/fit.data.training_1-2.png) ![](LiquidAssets_Wine2_files/figure-html/fit.data.training_1-3.png) ![](LiquidAssets_Wine2_files/figure-html/fit.data.training_1-4.png) ![](LiquidAssets_Wine2_files/figure-html/fit.data.training_1-5.png) ![](LiquidAssets_Wine2_files/figure-html/fit.data.training_1-6.png) 
...
## 12 1965 6.2518        602 15.3667         267  18  49801.82 Train
## 19 1972 6.2049        536 14.9833         158  11  52894.18 Train
##        .rnorm Price.predict.Final.lm Price.predict.Final.lm.err .label
## 6   0.5460432               7.575087                  0.5006127   1959
## 24 -0.7173456               6.732652                  0.4739520   1977
## 20  0.9435605               7.101442                  0.4647417   1973
## 12 -0.3541171               5.907425                  0.3443753   1965
## 19  0.3200711               5.888516                  0.3163840   1972
```

![](LiquidAssets_Wine2_files/figure-html/fit.data.training_1-7.png) 
...
```
## [1] Price                      Price.predict.Final.lm    
## [3] Price.predict.Final.lm.err
## <0 rows> (or 0-length row.names)
```
...
```
## [1] "Price.predict.Final.lm"     "Price.predict.Final.lm.err"
```
...
![](LiquidAssets_Wine2_files/figure-html/fit.data.training_1-8.png) 
...
```
##                label step_major step_minor    bgn    end elapsed
## 15 fit.data.training          8          1 59.588 63.246   3.658
## 16  predict.data.new          9          0 63.246     NA      NA
```
...
![](LiquidAssets_Wine2_files/figure-html/predict.data.new-1.png) 
...
![](LiquidAssets_Wine2_files/figure-html/predict.data.new-2.png) ![](LiquidAssets_Wine2_files/figure-html/predict.data.new-3.png) ![](LiquidAssets_Wine2_files/figure-html/predict.data.new-4.png) ![](LiquidAssets_Wine2_files/figure-html/predict.data.new-5.png) ![](LiquidAssets_Wine2_files/figure-html/predict.data.new-6.png) 
...
## 26 1979 6.9541        717 16.1667         122   4  54835.83 Test
##        .rnorm Price.predict.Final.lm Price.predict.Final.lm.err .label
## 27 -0.7757516               6.731440                  0.2335403   1980
## 26  0.6962816               6.844238                  0.1098618   1979
```

![](LiquidAssets_Wine2_files/figure-html/predict.data.new-7.png) 
...
```
##                   label step_major step_minor    bgn    end elapsed
## 16     predict.data.new          9          0 63.246 66.653   3.407
## 17 display.session.info         10          0 66.654     NA      NA
```
...
## 9  partition.data.training          6          0 15.768 16.061   0.294
## 7             cluster.data          4          0 14.954 15.213   0.259
## 5      manage.missing.data          2          3 13.819 13.880   0.061
## 4           transform.data          2          2 13.784 13.819   0.035
##    duration
## 11   13.962
## 10   13.152
...
## 5     0.061
## 4     0.035
## [1] "Total Elapsed Time: 66.653 secs"
```

![](LiquidAssets_Wine2_files/figure-html/display.session.info-1.png) 

```
##                   label step_major step_minor    bgn    end elapsed
## 3      fit.models_1_glm          3          0 33.042 36.378   3.336
## 6       fit.models_1_rf          6          0 40.731 43.170   2.439
## 2       fit.models_1_lm          2          0 30.677 33.042   2.365
## 4 fit.models_1_bayesglm          4          0 36.378 38.593   2.215
## 5    fit.models_1_rpart          5          0 38.594 40.731   2.137
## 1      fit.models_1_bgn          1          0 30.664 30.676   0.013
...
## 5    2.137
## 1    0.012
## [1] "Total Elapsed Time: 43.17 secs"
```

![](LiquidAssets_Wine2_files/figure-html/display.session.info-2.png) 
